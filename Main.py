...
def main():
	...
	sphere02 = Sphere(Vector(10,-20,-136),30,material=glass)
	sphere03 = Sphere(Vector(-15,-30,-120),20,material=glass)
	...
	newScene = Scene({"geometry":[quad01,quad02,quad03,quad04,quad05,sphere03],"light":[light02]})
